layui.define(['pearMessage', 'table', 'jquery', 'element', 'pearYaml', 'form', 'pearTab', 'pearMenu', 'pearFrame', 'pearTheme', 'pearConvert','pearFullscreen'],
	function(exports) {
		"use strict";
		...
		var $ = layui.jquery,
			...
			convert = layui.pearConvert,
			pearMenu = layui.pearMenu,
			pearFrame = layui.pearFrame,
			pearTheme = layui.pearTheme,
			message = layui.pearMessage,
			fullscreen=layui.pearFullscreen;
